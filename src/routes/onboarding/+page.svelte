...
<div class="relative z-10 flex flex-col items-center min-h-screen px-6 pt-12 pb-10 max-w-[420px] mx-auto">
  ...
  <div class="flex gap-2 mb-8">
    {#each stepLabels as _, i}
      <div class="w-2 h-2 rounded-full transition-all {i === step ? 'bg-primary scale-125' : i < step ? 'bg-primary/50' : 'bg-white/15'}"></div>
    {/each}
  </div>
  ...
  {#if step === 0}
    <div class="flex flex-col items-center text-center gap-6 animate-fade-in">
      ...
      <h1 class="text-2xl font-black tracking-[3px] uppercase">Health Disclaimer</h1>
      <div class="bg-surface rounded-[14px] p-5 text-sm text-dim leading-relaxed">
  ...
  {#if step === 1}
    <div class="flex flex-col items-center text-center gap-6 animate-fade-in">
      ...
      <h1 class="text-2xl font-black tracking-[3px] uppercase">Camera Setup</h1>
  ...
  {#if step === 2}
    <div class="flex flex-col items-center text-center gap-4 w-full animate-fade-in">
      <h1 class="text-xl font-black tracking-[3px] uppercase">Pose Check</h1>
  ...
  {#if step === 3}
    <div class="flex flex-col items-center text-center gap-4 w-full animate-fade-in">
      <h1 class="text-xl font-black tracking-[3px] uppercase">Test Reps</h1>
      ...
      <div class="relative w-full aspect-[3/4] bg-black rounded-[14px] overflow-hidden">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center pointer-events-none">
          <span class="text-[64px] font-black text-gold leading-none" style="text-shadow: 0 0 30px rgba(255,209,102,0.5)">{testReps}</span>
